...
public class UpdateClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upName.setHint("Enter Updated Class");
        ...
        udtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.updateClass(upName.getText().toString(), Integer.parseInt(uniqNo.getText().toString()));
                Toast.makeText(UpdateClass.this,"Data Updated Successfully",Toast.LENGTH_SHORT).show();
                upName.setText("");
                uniqNo.setText("");
