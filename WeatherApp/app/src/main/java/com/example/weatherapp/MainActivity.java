...
public class MainActivity extends AppCompatActivity {
    ...
    private void getWeatherInfo(String cityName){
        String url = "http://api.weatherapi.com/v1/forecast.json?key=2ad0703045734c36a1672336231703&q="+cityName+"&days=1&aqi=no&alerts=no";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    temperatureTV.setText(tempurature + "°C");
                    ...
                    if(isDay == 1){
                        Picasso.get().load("https://images.unsplash.com/photo-1561540537-6b12ec38096b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80").into(backIV);
                    }
                    else{
