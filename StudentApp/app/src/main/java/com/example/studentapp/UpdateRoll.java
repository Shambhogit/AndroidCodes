...
public class UpdateRoll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upName.setHint("Enter Updated Roll Number");
        ...
        udtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.updateRoll(Integer.parseInt(upName.getText().toString()), Integer.parseInt(uniqNo.getText().toString()));
                Toast.makeText(UpdateRoll.this,"Data Updated Successfully",Toast.LENGTH_SHORT).show();
                upName.setText("");
                uniqNo.setText("");
