...
public class UpdateTread extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upName.setHint("Enter Updated Tread");
        ...
        udtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.updateTread(upName.getText().toString(), Integer.parseInt(uniqNo.getText().toString()));
                Toast.makeText(UpdateTread.this,"Data Updated Successfully",Toast.LENGTH_SHORT).show();
                upName.setText("");
                uniqNo.setText("");
