...
public class UpdateCollege extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        upName.setHint("Enter Updated college name");
        ...
        udtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.updateCollege(upName.getText().toString(), Integer.parseInt(uniqNo.getText().toString()));
                Toast.makeText(UpdateCollege.this,"Data Updated Successfully",Toast.LENGTH_SHORT).show();
                upName.setText("");
                uniqNo.setText("");
